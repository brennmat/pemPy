...
try:
    ...
    LOADCELL = classes.loadcell_HX711.HX711( dout_pin=5,
                                             ...
                                             TZero = [1.0,0.0],      # no T compensation for [ 1.0 ,  0.0 ]
                                             TRatio = 0.0
                                           )
    ...
    input('Remove weight from load cell and press Enter')
    ...
    known_weight_grams = input('Put calibration weight on load cell and enter its weight (g): ')
    try:
